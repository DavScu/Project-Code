    ...
    while(1)
    {
        if(blueToothSerial.available())   // Check if there's any data sent from the remote Bluetooth shield
        {
            ...
            if (recvChar == 'w'){
              ...
              for(int i = 0; manualMoves[i] != 0 and i<50; i++){
                if(manualMoves[i] == 'w'){
                  forward();
                }
                if(manualMoves[i] == 'd'){
              ...
              i=0;
              while(i<500){
                if(autoMoves[i] == 'w' and runTime != 0){
                  servoLeft.writeMicroseconds(1700);
                  servoRight.writeMicroseconds(1300);
                  delay(50);
                  runTime = runTime - 1;
                }
                if(autoMoves[i] == 'a' and runTime != 0){
                  servoLeft.writeMicroseconds(1600);
                  servoRight.writeMicroseconds(1550);
                  delay(50);
                  runTime = runTime - 1;
                }
                if(autoMoves[i] == 'd' and runTime != 0){
              ...
              servoLeft.detach();
              servoRight.detach();
              for(int i = 49; manualMoves[i] != 0 and i>=0; i=i-1){
                if(manualMoves[i] == 'w'){
                  backward();
                }
                if(manualMoves[i] == 'd'){
